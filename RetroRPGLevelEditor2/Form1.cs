...
namespace RetroRPGLevelEditor2
{
    public partial class Form1 : Form
    {
        ...
        public enum status
        {
            free, wall, moveableWall, player, item, coin, enemy, area
        };
        ...
        Bitmap contentArea = new Bitmap("area.png");
        ...
        void HandleMouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Left && Control.ModifierKeys == Keys.None)
            {
                if (tile.tile == status.free)
                {
                    ...
                    if (comboBox1.SelectedIndex == (int)objects.Area)
                    {
                        grid[x, y] = status.area;
                        pointList[y * mapHeight + x].tile = status.area;
                        tile.image = contentArea;
                    }
                }
                else
                {
...
#warning Mouse exited grid area;
        ...
        enum objects
        {
            Wall, MoveableWall, Player, Item, Coin, Enemy, Area
        };
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox1.SelectedIndex == (int)objects.Area)
            {
                oThumnail.Image = Image.FromFile("areaThumnail.png");
            }
        }
        ...
        private void oLoad_Click(object sender, EventArgs e)
        {
            ...
            while ((line = sr.ReadLine()) != null)
            {
                if (parsingEntity == false)
                {
                    ...
                    else if (line == "[oWall]" || line == "[oGold]" || line == "[oMoveableWall]" || line == "[oPlayer]" || line == "[oArea]")
                    {
                        parsingEntity = true;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (parsingEntityTitle == "[oArea]")
                        {
                            parsingTile.image = contentArea;
                            parsingTile.tile = status.area;
                        }
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            if (treeView1.SelectedNode == terrainNode.Nodes["Oblast"])
            {
                LogEvent("Vybráno: Oblast", 3);
                comboBox1.SelectedItem = "Oblast";
            }
        }
        ...
        void AddNodes()
        {
            ...
            AdvancedNode terrainNodeArea = new AdvancedNode("Oblast");
            terrainNode.Nodes.Add(terrainNodeArea);
        ...
        List<string> getEvents(Tile tile)
        {
